...
def get_config():
  ...
  # Training settings
  config.log_dir = './runs/X'  # Directory to save logs and summaries
  ...
  config.optim = {
    ...
    'adv_train': {
      ...
      'rand_init': False,  # Initialize the perturbation randomly
      'post_normalize': False,  # Normalize and rescale final perturbations
